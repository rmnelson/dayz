...
/*  ALLOWED Dialogs       */ _ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,55510,20001];
...
[
	"ItemMap_Debug","ItemCore","Laserdesignator","PMC_AS50_TWS_Large","Javelin","M136","Igla",
	"Strela","Stinger","MetisLauncher","m107_TWS_EP1","m107_TWS_EP1_DZ","BAF_NLAW_Launcher",
	"M110_TWS_EP1","M47Launcher_EP1","MAAWS","BAF_AS50_TWS","FHQ_MSR_TWS_DESERT","FHQ_MSR_TWS_SD_DESERT",
	"FHQ_RSASS_TWS_TAN","FHQ_RSASS_TWS_SD_TAN","FHQ_MX2010_TWS_DESERT","FHQ_XM2010_TWS_SD_DESERT",
	"Vil_RPG16","Vil_RPG7V_PGO","Vil_RPG7d_PGO","Vil_RPG29","Vil_RPO_A","vilas_rpg22","vilas_rpg26",
	"vil_CG84T","vil_Panzerfaust3","M249_TWS_EP1","SCAR_L_STD_EGLM_TWS","SCAR_H_STD_TWS_SD","m8_tws_sd", 
	"m8_tws","FHQ_ACR_SNW_TWS","FHQ_ACR_SNW_TWS_F","FHQ_ACR_SNW_TWS_SD","FHQ_ACR_SNW_TWS_SD_F",	
	"FHQ_ACR_SNW_TWS_GL","FHQ_ACR_SNW_TWS_GL_F","FHQ_ACR_SNW_TWS_GL_SD","FHQ_ACR_SNW_TWS_GL_SD_F",
	"FHQ_ACR_TAN_TWS","FHQ_ACR_TAN_TWS_F","FHQ_ACR_TAN_TWS_SD","FHQ_ACR_TAN_TWS_SD_F",	
	"FHQ_ACR_TAN_TWS_GL","FHQ_ACR_TAN_TWS_GL_F","FHQ_ACR_TAN_TWS_GL_SD","FHQ_ACR_TAN_TWS_GL_SD_F",
	"FHQ_ACR_BLK_TWS","FHQ_ACR_BLK_TWS_F","FHQ_ACR_BLK_TWS_SD","FHQ_ACR_BLK_TWS_SD_F",	
	"FHQ_ACR_BLK_TWS_GL","FHQ_ACR_BLK_TWS_GL_F","FHQ_ACR_BLK_TWS_GL_SD","FHQ_ACR_BLK_TWS_GL_SD_F",
	"FHQ_ACR_WDL_TWS","FHQ_ACR_WDL_TWS_F","FHQ_ACR_WDL_TWS_SD","FHQ_ACR_WDL_TWS_SD_F",   
	"FHQ_ACR_WDL_TWS_GL","FHQ_ACR_WDL_TWS_GL_F","FHQ_ACR_WDL_TWS_GL_SD","FHQ_ACR_WDL_TWS_GL_SD_F"	
];
/* ********************************************************************************* */
...
[
	...
	"BTC_Hud","GivePlayerDialog","BankDialog","TraderDialog","SCTraderDialog","TraderDialogLoadItemList","TraderDialogShowPrices",
	"TraderDialogBuy","TraderDialogSell","MetalTradeMenuTID","_dialog","s_player_parts_crtl"
	];
/* ********************************************************************************* */
...
[
	...
	"s_bank_dialog2","s_bank_dialog1","s_givemoney_dialog","_buy","_dialog","s_player_parts_crtl",
	"TraderDialogLoadItemList","TraderDialogShowPrices","MetalTradeMenuTID",
	"TraderDialogBuy","TraderDialogSell","_trader_data","SCTraderCatList","SCTraderItemList","SCTraderCurrentCatIndex",
