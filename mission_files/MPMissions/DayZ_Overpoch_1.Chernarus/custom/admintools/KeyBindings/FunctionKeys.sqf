...
F1_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 59) then {[] execVM ""custom\admintools\tools\Teleport\Teleport.sqf"";true};"];
Sleep 0.02;
F2_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 60) then {[] execVM ""custom\admintools\tools\Teleport\TPtoME.sqf"";true};"];
Sleep 0.02;
F3_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 61) then {[] execVM ""custom\admintools\tools\Teleport\TpToPlayer.sqf"";true};"];
// F4 is reserved for AdminMode.sqf and modMode.sqf
// F5 is reserved for ESPenhanced.sqf
// F6 is reserved for spectate.sqf
Sleep 0.02;
// F7_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 65) then {[] execVM ""custom\admintools\DIRECTORY_HERE\FILE_NAME_HERE.sqf"";true};"];
Sleep 0.02;
// F8_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 66) then {[] execVM ""custom\admintools\DIRECTORY_HERE\FILE_NAME_HERE.sqf"";true};"];
Sleep 0.02;
// F9_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 67) then {[] execVM ""custom\admintools\DIRECTORY_HERE\FILE_NAME_HERE.sqf"";true};"];
Sleep 0.02;
...
// F12_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 88 then {[] execVM ""custom\admintools\DIRECTORY_HERE\FILE_NAME_HERE.sqf"";true};"];
