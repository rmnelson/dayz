...
modToggleON =
{
	if (playerESP) then {[] execVM "custom\admintools\tools\AdminMode\ESPplayer.sqf";};
	if (invisibility) then {[] execVM "custom\admintools\tools\AdminMode\Invisibility.sqf";};
	if (infAmmo) then {[] execVM "custom\admintools\tools\AdminMode\InfiniteAmmo.sqf";};
	if (playerGod) then {[] execVM "custom\admintools\tools\AdminMode\GodModePlayer.sqf";};
	if (vehicleGod) then {[] execVM "custom\admintools\tools\AdminMode\GodModeVehicle.sqf";};
	if (grassOff) then {[] execVM "custom\admintools\tools\AdminMode\GrassOFF.sqf";};
};
