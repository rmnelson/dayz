...
playerGodToggle = {
	playerGod = !playerGod;
	[] execVM "custom\admintools\tools\AdminMode\GodModePlayer.sqf";
};
vehicleGodToggle = {
	vehicleGod = !vehicleGod;
	[] execVM "custom\admintools\tools\AdminMode\GodModeVehicle.sqf";
};
playerESPToggle = {
	playerESP = !playerESP;
	if(playerESP && enhancedESP) then {enhancedESP = false; [enhancedESP] execVM "custom\admintools\tools\AdminMode\ESPenhanced.sqf";};
	[] execVM "custom\admintools\tools\AdminMode\ESPplayer.sqf";
};
enhancedESPToggle = {
	enhancedESP = !enhancedESP;
	if(playerESP && enhancedESP) then {playerESP = false; [playerESP] execVM "custom\admintools\tools\AdminMode\ESPplayer.sqf";};
	[] execVM "custom\admintools\tools\AdminMode\ESPenhanced.sqf";
};
grassOffToggle = {
	grassOff = !grassOff;
	[] execVM "custom\admintools\tools\AdminMode\GrassOFF.sqf";
};
infAmmoToggle = {
	infAmmo = !infAmmo;
	[] execVM "custom\admintools\tools\AdminMode\InfiniteAmmo.sqf";
};
speedBoostToggle = {
	speedBoost = !speedBoost;
	[] execVM "custom\admintools\tools\AdminMode\speedboost.sqf";
};
invisibilityToggle = {
	invisibility = !invisibility;
	[] execVM "custom\admintools\tools\AdminMode\Invisibility.sqf";
};
flyingToggle = {
	flying = !flying;
	[] execVM "custom\admintools\tools\AdminMode\Flying.sqf";
};
...
AdminToggleON =
{
	if (speedBoost) then {[] execVM "custom\admintools\tools\AdminMode\speedboost.sqf";}; Sleep 0.1;
	if (enhancedESP) then {[] execVM "custom\admintools\tools\AdminMode\ESPenhanced.sqf";}; Sleep 0.1;
	if (playerESP) then {[] execVM "custom\admintools\tools\AdminMode\ESPplayer.sqf";}; Sleep 0.1;
	if (invisibility) then {[] execVM "custom\admintools\tools\AdminMode\Invisibility.sqf";}; Sleep 0.;
	if (infAmmo) then {[] execVM "custom\admintools\tools\AdminMode\InfiniteAmmo.sqf";}; Sleep 0.1;
	if (flying) then {[] execVM "custom\admintools\tools\AdminMode\Flying.sqf";}; Sleep 0.1;
	if (playerGod) then {[] execVM "custom\admintools\tools\AdminMode\GodModePlayer.sqf";}; Sleep 0.1;
	if (vehicleGod) then {[] execVM "custom\admintools\tools\AdminMode\GodModeVehicle.sqf";}; Sleep 0.1;
	if (grassOff) then {[] execVM "custom\admintools\tools\AdminMode\GrassOFF.sqf";}; Sleep 0.1;
};
...
AdminToggleOFF =
{
	...
	if (enhancedESP) then {[] execVM "custom\admintools\tools\AdminMode\ESPenhanced.sqf";}; Sleep 0.1;
	if (playerESP) then {[] execVM "custom\admintools\tools\AdminMode\ESPplayer.sqf";}; Sleep 0.1;
	if (invisibility) then {[] execVM "custom\admintools\tools\AdminMode\Invisibility.sqf";}; Sleep 0.1;
	if (infAmmo) then {[] execVM "custom\admintools\tools\AdminMode\InfiniteAmmo.sqf";}; Sleep 0.1;
	if (flying) then {[] execVM "custom\admintools\tools\AdminMode\Flying.sqf";}; Sleep 0.1;
	if (playerGod) then {[] execVM "custom\admintools\tools\AdminMode\GodModePlayer.sqf";}; Sleep 0.1;
	if (vehicleGod) then {[] execVM "custom\admintools\tools\AdminMode\GodModeVehicle.sqf";}; Sleep 0.1;
