...
if(isNil "DZE_CLICK_ACTIONS_BUILD") then {
    ...
    call compile preprocessFileLineNumbers "custom\bike\overwrites\click_actions\config.sqf";
    player_selectSlot = compile preprocessFileLineNumbers "custom\bike\overwrites\click_actions\ui_selectSlot.sqf";
