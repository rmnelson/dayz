...
_role1 = "Welcome to";
_role1names = ["Drinkin Outa Cups"];
_role2 = "Admins";
_role2names = ["DaBetham"];
_role3 = "Server mod";
...
_role6 = "Team Speak 3";
_role6names = ["ts.doc-clan.com"];
_role7 = "Website";
_role7names = ["doc-clan.com"];
_role8 = "Special Thanks";
_role8names = ["infiSTAR.de","ArmAholic.com", "OpendayZ.net", "Epochmod.com"];
