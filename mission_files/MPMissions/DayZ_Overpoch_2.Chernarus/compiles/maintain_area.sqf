...
switch true do {
	...
	case (_count <= 35):  {_requirements = [[CurrencyName,15000]]};
	case (_count <= 50):  {_requirements = [[CurrencyName,20000]]};
	case (_count <= 75):  {_requirements = [[CurrencyName,30000]]};
	case (_count <= 100): {_requirements = [[CurrencyName,50000]]};
	case (_count <= 175): {_requirements = [[CurrencyName,100000]]};
	case (_count <= 250): {_requirements = [[CurrencyName,150000]]};
	case (_count <= 325): {_requirements = [[CurrencyName,200000]]};
	case (_count <= 400): {_requirements = [[CurrencyName,250000]]};
	case (_count <= 475): {_requirements = [[CurrencyName,300000]]};
	case (_count <= 550): {_requirements = [[CurrencyName,350000]]};
	case (_count <= 625): {_requirements = [[CurrencyName,400000]]};
	case (_count > 625):  {_requirements = [[CurrencyName,500000]]};
};
