...
if (!isDedicated) then {
	...
	fnc_usec_damageActions =		compile preprocessFileLineNumbers "compiles\fn_damageActions.sqf";		//Checks which actions for nearby casualty
	fnc_inAngleSector =				compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_inAngleSector.sqf";		//Checks which actions for nearby casualty
	fnc_usec_selfActions =			compile preprocessFileLineNumbers "compiles\fn_selfActions.sqf";		//Checks which actions for self
	fnc_usec_unconscious =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_unconscious.sqf";
	player_temp_calculation	=		compile preprocessFileLineNumbers "custom\fn_temperatur.sqf";		//Temperatur System	//TeeChange
	...
	dayz_spaceInterrupt =			compile preprocessFileLineNumbers "compiles\dayz_spaceInterrupt.sqf";
	...
	player_death =				compile preprocessFileLineNumbers "compiles\player_death.sqf";   //Skin
	player_switchModel =		compile preprocessFileLineNumbers "compiles\player_switchModel.sqf";
	...
	fn_gearMenuChecks =			compile preprocessFileLineNumbers "compiles\fn_gearMenuChecks.sqf";
	...
	player_craftItem =			compile preprocessFileLineNumbers "compiles\player_craftItem.sqf";
	player_tentPitch =			compile preprocessFileLineNumbers "compiles\tent_pitch.sqf";
	player_vaultPitch =			compile preprocessFileLineNumbers "compiles\vault_pitch.sqf";
	...
	player_build =				compile preprocessFileLineNumbers "custom\snap_pro\player_build.sqf";					//Snap Pro Etc
	snap_build = 				compile preprocessFileLineNumbers "custom\snap_pro\snap_build.sqf";                       // Snap Pro
