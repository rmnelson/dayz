...
_servicePointClasses = ["Land_A_FuelStation_Feed"]; // service point classes (can be house, vehicle and unit classes)
...
_message = ""; // message to be shown when in range of a service point (set to "" to disable)
