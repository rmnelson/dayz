...
if (isClass (missionConfigFile >> "SnapBuilding" >> _classname)) then {	
	...
	//Forbidden Buildings
	_isNear = count (nearestObjects [player, ["Land_a_stationhouse","Land_A_Hospital","Land_Mil_Barracks_i","Land_Mil_Barracks","Land_SS_hangar","Land_Mil_ControlTower","Land_Mil_House"], 50]);
