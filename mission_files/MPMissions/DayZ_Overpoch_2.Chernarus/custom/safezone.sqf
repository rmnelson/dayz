...
SPEEDLIMIT = 45;		// Only used if USE_SPEEDLIMIT is true.
...
_infiSZ =
[
	[[6325.6772,7807.7412,0],125,true],
	[[4063.4226,11664.19,0],125,true],
	[[11447.472,11364.504,0],125,true],
	[[1606.6443,7803.5156,0],75,true],
	[[12944.227,12766.889,0],75,true],
	[[3445.0112,3804.1453,0],90,true],
	[[10704.113,5362.7793,0],90,true],	
	[[12060.471,12638.533,0],50,true],
	[[4962.320,9731.850,0],50,true]
];
