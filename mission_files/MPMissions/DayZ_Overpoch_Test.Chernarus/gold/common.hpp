class Life_RscScrollBar
{
	...
	thumb = "gold\gui\thumb_ca.paa";
	arrowEmpty = "gold\gui\arrowEmpty_ca.paa";
	arrowFull = "gold\gui\arrowFull_ca.paa";
	border = "gold\gui\border_ca.paa";
	shadow = 0;
	scrollSpeed = 0.06;
	width = 0;
	height = 0;
...
class Life_RscTree {
	...
	expandedTexture = "gold\gui\expandedTexture_ca.paa";
	hiddenTexture = "gold\gui\hiddenTexture_ca.paa";
	rowHeight = 0.0439091;
	color[] = {1, 1, 1, 1};
...
class Life_RscShortcutButton {
	...
	animTextureDefault = "gold\gui\normal_ca.paa";
	animTextureNormal = "gold\gui\normal_ca.paa";
	animTextureDisabled = "gold\gui\normal_ca.paa";
	animTextureOver = "gold\gui\over_ca.paa";
	animTextureFocused = "gold\gui\focus_ca.paa";
	animTexturePressed = "gold\gui\down_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class Life_RscShortcutButtonMain : Life_RscShortcutButton {
	...
	animTextureNormal = "gold\gui\main\normal_ca.paa";
	animTextureDisabled = "gold\gui\main\disabled_ca.paa";
	animTextureOver = "gold\gui\main\over_ca.paa";
	animTextureFocused = "gold\gui\main\focus_ca.paa";
	animTexturePressed = "gold\gui\main\down_ca.paa";
	animTextureDefault = "gold\gui\main\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class life_RscXSliderH 
{
	...
	arrowEmpty = "gold\gui\slider\arrowEmpty_ca.paa";
	arrowFull = "gold\gui\slider\arrowFull_ca.paa";
	border = "gold\gui\slider\border_ca.paa";
	thumb = "gold\gui\slider\thumb_ca.paa";
};
...
class Life_RscHTML {
	...
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "gold\gui\arrow_left_ca.paa";
	nextPage = "gold\gui\arrow_right_ca.paa";
	shadow = 2;
...
class Life_RscCombo {
	...
	arrowFull = "gold\gui\arrowFull_sca.paa";
	arrowEmpty = "gold\gui\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	color[] = {1, 1, 1, 1};
	colorActive[] = {1, 0, 0, 1};
