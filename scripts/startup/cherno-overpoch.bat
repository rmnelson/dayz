...
REM taskkill /fi "WINDOWTITLE eq ArmA 2 OA Console version 1.63 : port 2302"
taskkill /f /im arma2oaserver-b2.exe
...
:: start the server..
start "cherno" /min "D:\dayz\a2oa\arma2oaserver-b2.exe" -port=2302 "-config=D:\dayz\instances\Chernarus.2_Overpoch\config.cfg" "-cfg=D:\dayz\instances\Chernarus.2_Overpoch\basic.cfg" "-profiles=D:\dayz\instances\Chernarus.2_Overpoch" "-name=D:\dayz\instances\Chernarus.2_Overpoch" "-mod=@DayZOverwatch;@DayZ_Epoch;@DayZ_Epoch_Server.b2" "-ranking=D:\dayz\instances\Chernarus.2_Overpoch\ranking.log" -nosplash -noPause -noSound -cpuCount=2 -bandwidthAlg=2 -exThreads=7
...
:: start bec..
D:\dayz\instances\Chernarus.2_Overpoch\BattlEye\bec\start_bec.bat
