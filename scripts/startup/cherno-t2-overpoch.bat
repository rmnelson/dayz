...
set cherno_bec_path="D:\dayz\instances\Chernarus.t2_Overpoch\BattlEye\bec"
...
:: start the server..
start "cherno" /min "D:\dayz\a2oa\arma2oaserver.exe" -port=2312 "-config=D:\dayz\instances\Chernarus.t2_Overpoch\config.cfg" "-cfg=D:\dayz\instances\Chernarus.t2_Overpoch\basic.cfg" "-profiles=D:\dayz\instances\Chernarus.t2_Overpoch" "-name=D:\dayz\instances\Chernarus.t2_Overpoch" "-mod=@DayZOverwatch;@DayZ_Epoch;@DayZ_Epoch_Server.t2" -noPause -noSound -cpuCount=2 -bandwidthAlg=2 -exThreads=2
...
:: start bec..
D:\dayz\instances\Chernarus.t2_Overpoch\BattlEye\bec\start_bec.bat
